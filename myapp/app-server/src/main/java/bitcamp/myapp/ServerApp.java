...
import bitcamp.myapp.handler.BoardServlet;
import bitcamp.myapp.handler.StudentServelet;
import bitcamp.myapp.handler.TeacherServlet;
...
public class ServerApp {
  ...
  void service(int port) {
    ...
    try (ServerSocket serverSocket = new ServerSocket(port)) {
      ...
      StudentServelet studentServlet = new StudentServelet("학생");

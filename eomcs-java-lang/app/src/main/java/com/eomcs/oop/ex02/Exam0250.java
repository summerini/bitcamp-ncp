...
public class Exam0250 {
  ...
  public static void main(String[] args) {
    ...
    Calculator c3 = new Calculator(); // 식3의 계산 결과를 보관할 메모리 준비
    Calculator c4 = new Calculator(); // 식4의 계산 결과를 보관할 메모리 준비

    // 계산을 수행할 때 계산 결과를 보관할 메모리를 전달한다.
    Calculator.plus(c1, 2); // + 2
    Calculator.plus(c2, 3); // + 3
    Calculator.plus(c3, 3); // + 3
    Calculator.plus(c4, 3); // + 3

    Calculator.plus(c1, 3); // + 2 + 3
    Calculator.multiple(c2, 2); // + 3 * 2
    Calculator.multiple(c3, 2); // + 3 * 2
    Calculator.multiple(c4, 2); // + 3 * 2

    Calculator.minus(c1, 1); // + 2 + 3 - 1
    Calculator.plus(c2, 7); // + 3 * 2 + 7
    Calculator.plus(c3, 7); // + 3 * 2 + 7
    Calculator.minus(c4, 1); // + 2 + 3 - 1

    Calculator.multiple(c1, 7); // + 2 + 3 - 1 * 7
    Calculator.divide(c2, 4); // + 3 * 2 + 7 / 4
    Calculator.divide(c3, 4); // + 3 * 2 + 7 / 4
    Calculator.divide(c4, 4); // + 3 * 2 + 7 / 4

    Calculator.divide(c1, 3); // + 2 + 3 - 1 * 7 / 3 = ?
    Calculator.minus(c2, 5); // + 3 * 2 + 7 / 4 - 5 = ?
    Calculator.divide(c3, 3); // + 2 + 3 - 1 * 7 / 3 = ?
    Calculator.minus(c4, 5); // + 3 * 2 + 7 / 4 - 5 = ?
